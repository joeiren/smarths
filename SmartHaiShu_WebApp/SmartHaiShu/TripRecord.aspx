    ...
    <div id="container1" class="container container_bg">
        ...
        <form class="form-horizontal" role="form">
          ...
          <div class="form-group">
            <label for="txtCarNo" class="col-md-3 control-label">车牌号码：</label>
            <div class="col-md-2">
              <input type="text" class="form-control" style="width: 300px;" id="txtCarNo" autofocus="true" required="" value="浙B·"  maxlength="10">
            </div>
          </div>
          <div class="form-group">
            <label for="txtCardSeq" class="col-md-3 control-label">车辆识别代码：</label>
            <div class="col-md-2">
              <input type="text" class="form-control" style="width: 300px;" id="txtCardSeq" placeholder="" required="" maxlength="6">
            </div>
          </div>
          <div class="form-group">
            <label for="selCarType" class="col-md-3 control-label">车辆类型：</label>
            <div class="col-md-4">
              <select id="selCarType" class="form-control" style="width: 300px;" >
          ...
          <div class="form-group">
            <label for="txtCode" class="col-md-3 control-label">验证码：</label>
            <div class="col-md-2">
              <input type="text" class="form-control" style="width: 300px;"  id="txtCode"  required="" maxlength="6">
          ...
          <div class="form-group">
            <div class="col-md-offset-3 col-md-2">
              <button type="submit" class="btn btn-primary btn-block" style="width: 300px;" onclick="onSubmit();return false;">查询</button>
            </div>
          </div>
        </form>
        </div>
