    ...
    */
    ...
    PPTBox.prototype =
    {
        _createMainBox : function (){
            ...
            html += "</div>";
            html += "<div style=\"width:" + this.width + "px; text-align: center;\"><div id='" + this.uid + "_imagebox' class='imagebox' style='height:" + (this.picHeight + 2) + "px;top:0px;'></div></div>";  /*+(this.picHeight + 20) + "px;'></div>";*/
            document.write(html);
        },
        _init : function (){
            var picstyle= "";
            ...
            //$("div#getimg").innerHTML = imageHTML;
        },
        _play : function(){
