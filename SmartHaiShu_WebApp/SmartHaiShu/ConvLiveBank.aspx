<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConvLiveBank.aspx.cs" Inherits="SmartHaiShu_WebApp.SmartHaiShu.ConvLiveBank" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function trunPage(pageNo, next) {
            ...
            if (next == undefined) {
                if (pageNo != currpage) {
                    location.href = "ConvLiveBank.aspx?PageNo=" + pageNo ;     
                }

            } else {
                if ((currpage != maxPageNo && next )|| (!next && currpage != 1))

                    location.href = "ConvLiveBank.aspx?PageNo=" + (currpage + (next?1:-1)); 
            }
        }
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                ...
                <div class="panel panel-info">
                    ...
                    <div id="collapse<%#Container.ItemIndex+1 %>"  class="<%#Container.ItemIndex==0? "panel-collapse collapse in" : "panel-collapse collapse" %> ">
                        ...
                        <div class="panel-body" style="font-size: 12px;height: 110px;overflow-y:auto; ">
