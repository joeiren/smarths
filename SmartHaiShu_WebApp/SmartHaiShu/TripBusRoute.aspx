<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripBusRoute.aspx.cs" Inherits="SmartHaiShu_WebApp.SmartHaiShu.BusRoute" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function trunPage(pageNo, next) {
            ...
            if (next == undefined) {
                if (pageNo != currpage) {
                    location.href = "BusRoute.aspx?PageNo=" + pageNo;     
                }

            } else {
                if ((currpage != maxPageNo && next )|| (!next && currpage != 1))
                location.href = "BusRoute.aspx?PageNo=" + currpage + "&Next=" + next;
            }
        }
