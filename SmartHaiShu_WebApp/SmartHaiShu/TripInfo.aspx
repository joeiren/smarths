<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TripInfo.aspx.cs" Inherits="SmartHaiShu_WebApp.SmartHaiShu.TripInfo" %>
...
<head  runat="server">
    ...
    <script type="text/javascript">
        ...
        function trunPage(pageNo, next) {
            ...
            if (next == undefined) {
                if (pageNo != currpage) {
                    location.href = "TripInfo.aspx?PageNo=" + pageNo;
                }

            } else {
                if ((currpage != maxPageNo && next) || (!next && currpage != 1))
                    location.href = "TripInfo.aspx?PageNo=" + currpage + "&Next=" + next;
            }
        }
