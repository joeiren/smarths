<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EduHealth.aspx.cs" Inherits="SmartHaiShu_WebApp.SmartHaiShu.EduHealth" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function trunPage(pageNo, next) {
            ...
            if (next == undefined) {
                if (pageNo != currpage) {
                    location.href = "EduHealth.aspx?PageNo=" + pageNo;
                }

            } else {
                if ((currpage != maxPageNo && next) || (!next && currpage != 1))
                    location.href = "EduHealth.aspx?PageNo=" + currpage + "&Next=" + next;
            }
        }
