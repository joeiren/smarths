<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LifeSpecial.aspx.cs" Inherits="SmartHaiShu_WebApp.SmartHaiShu.LifeSpecial" %>
    ...
    <head runat="server">
        ...
        <script type="text/javascript">
            ...
            function trunPage(pageNo, next) {
                ...
                if (next == undefined) {
                    if (pageNo != currpage) {
                        location.href = "LifeSpecial.aspx?PageNo=" + pageNo;
                    }

                } else {
                    if ((currpage != maxPageNo && next) || (!next && currpage != 1))
                        location.href = "LifeSpecial.aspx?PageNo=" + currpage + "&Next=" + next;
                }
            }
