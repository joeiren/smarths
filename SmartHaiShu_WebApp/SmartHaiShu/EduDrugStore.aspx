<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EduDrugStore.aspx.cs" Inherits="SmartHaiShu_WebApp.SmartHaiShu.EduDrugStore" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function trunPage(pageNo, next) {
            ...
            if (next == undefined) {
                if (pageNo != currpage) {
                    location.href = "EduDrugStore.aspx?PageNo=" + pageNo ;     
                }

            } else {
                if ((currpage != maxPageNo && next )|| (!next && currpage != 1))

                    location.href = "EduDrugStore.aspx?PageNo=" + (currpage + (next?1:-1)); 
            }
        }
